...
docker run -dt --name vroom \
    ...
    cyclonecouriers/vroom-docker:v1.13.0
```

If you want to build the image yourself, run a

`docker build -t cyclonecouriers/vroom-docker:v1.13.0 --build-arg VROOM_RELEASE=v1.13.0 --build-arg VROOM_EXPRESS_RELEASE=v0.11.0 .`
